...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { brand: @sensor.brand, installation_date: @sensor.installation_date, serial_number: @sensor.serial_number, status: @sensor.status, store_id: @sensor.store_id } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { brand: @sensor.brand, installation_date: @sensor.installation_date, serial_number: @sensor.serial_number, status: @sensor.status, store_id: @sensor.store_id } }
